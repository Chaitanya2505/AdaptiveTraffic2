"""
RT-DETR (Real-Time Detection Transformer) Live BRTS Detection & 1:1 Sync Test
Uses Baidu / Ultralytics RT-DETR (Vision Transformer with NMS-Free Attention)
"""
...
# Load RT-DETR Vision Transformer
from ultralytics import RTDETR

print("=" * 65)
print("   RT-DETR TRANSFORMER: REAL-TIME 1:1 SYNC BRTS TEST")
print("=" * 65)

model_weights = "rtdetr-l.pt"
print(f"Loading Model  : Baidu / Ultralytics RT-DETR ({model_weights})...")
model = RTDETR(model_weights)
print("Model Ready    : RT-DETR Transformer weights loaded successfully.")
...
output_video_path = output_dir / "brts_rtdetr_detection.mp4"
...
window_name = "Surat BRTS Lane Guard - RT-DETR Transformer (1X Sync)"
has_gui = True
try:
...
try:
    while True:
        ...
        cv2.putText(annotated_frame, "RT-DETR BRTS GUARD [REC]", (15, 27),
