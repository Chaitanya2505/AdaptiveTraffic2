...
def download_model(model_size):
    # Prefer local weights stored in the project folder.
    ...
    # Fallback to downloading from Hugging Face if local weights not present
    try:
        from huggingface_hub import hf_hub_download
        print(f"[INFO] Local model not found. Downloading: {filename}")
